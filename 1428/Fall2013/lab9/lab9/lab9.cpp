...
// Fill out the body of the Get_base_of_triangle(). It should
// be similar to the function right above it.
//
// The fill out the body of the main function, following the
// directions given in the comments. Remove this first block
// of comments, leaving only your normal header and the description
// below.
